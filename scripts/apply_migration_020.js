...
async function main() {
  console.log("Applying Migration 020 (Storefront Blogs) to Supabase database...");
  const migrationPath = path.join(__dirname, '..', 'supabase', 'migrations', '020_add_storefront_blogs.sql');
